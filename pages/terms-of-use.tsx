...
function Termsofuse() {
  return (
    <>
      ...
      <main className="w-full bg-navbarBg text-white px-14 py-7">
        <h1 className="font-semibold text-3xl my-4">Privacy Policy</h1>
        ...
        <h3 className="font-semibold text-xl my-4">Interpretation</h3>
        <p>
        ...
        <h3 className="font-semibold text-xl my-4">Definitions</h3>
        ...
        <ul>
          ...
          <li className="my-2">
            <p>
              ...
              in this Agreement) refers to RunJs, Bangalore.
            </p>
          </li>
          <li className="my-2">
            <p>
          ...
          <li className="my-2">
            <p>
              <strong>Website</strong> refers to RunJs, accessible from{" "}
              <a
                href="https://runjs.in/"
        ...
        <h4 className="font-semibold text-lg my-4">Personal Data</h4>
        <p>
        ...
        <h4 className="font-semibold text-lg my-4">Usage Data</h4>
        ...
        <h4 className="font-semibold text-lg my-4">Business Transactions</h4>
        <p>
        ...
        <h4 className="font-semibold text-lg my-4">Law enforcement</h4>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h4 className="font-semibold text-lg my-4">Other legal requirements</h4>
        <p>
          The Company may disclose Your Personal Data in the good faith belief
          that such action is necessary to:
        </p>
        <ul>
          <li className="my-2">Comply with a legal obligation</li>
          <li className="my-2">
          ...
          <li className="my-2">Protect against legal liability</li>
        </ul>
        <h3 className="font-semibold text-xl my-4">
        ...
        <h2 className="font-semibold text-3xl my-4">Children's Privacy</h2>
        <p>
        ...
        <h2 className="font-semibold text-3xl my-4">Links to Other Websites</h2>
        <p>
        ...
        <h2 className="font-semibold text-3xl my-4">Contact Us</h2>
        <p>
          If you have any questions about this Privacy Policy, You can contact
          us:
        </p>
        <ul>
          <li className="my-2">By email: contact@runjs.in</li>
        </ul>
      </main>
    </>
  );
