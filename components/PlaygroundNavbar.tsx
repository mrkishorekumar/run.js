  ...
  return (
    <nav className="h-7vh w-full flex items-center bg-navbarBg">
      <div className="w-full h-full pr-3 flex flex-row justify-between items-center">
        {codeOption ? (
          <>
            <div className="h-full bg-ideBg px-3 py-2 flex justify-center items-center gap-2">
              {lang ? (
                <svg
              ...
              <p className="text-white text-base font-semibold font-sans">
                {fileName ? fileName : "main"}.{lang ? "js" : "ts"}
              </p>
            </div>
            <div className="h-full flex justify-center items-center gap-4">
              {showUpload ? (
                <button
                  ref={updatebuttonRef}
                  className="bg-transparent p-1 border border-borderColor rounded text-white px-2 py-1 flex gap-2"
                  onClick={() => (updateCode ? updateCode() : undefined)}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    height="24px"
              ...
              <button
                ...
                onClick={() =>
                  toggleLangFunction ? toggleLangFunction() : undefined
                }
              >
                {lang ? (
                  <svg
              ...
              <button
                className="bg-transparent p-1 border border-borderColor rounded"
                onClick={() =>
                  formatCodeFunction ? formatCodeFunction() : undefined
                }
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <button
                className="bg-transparent p-1 border border-borderColor rounded"
                onClick={() =>
                  increaseFontSize ? increaseFontSize() : undefined
                }
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <button
                className="bg-transparent p-1 border border-borderColor rounded"
                onClick={() =>
                  decreaseFontSize ? decreaseFontSize() : undefined
                }
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <>
            ...
            <div className="h-full flex justify-center items-center gap-4">
              ...
              <button
                className="bg-transparent p-1 border border-borderColor rounded"
                onClick={() =>
                  clearAllConsoleLogs ? clearAllConsoleLogs() : undefined
                }
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
